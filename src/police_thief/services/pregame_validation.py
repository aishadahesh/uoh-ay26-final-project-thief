...
_SCHEMA: dict[str, dict[str, type | tuple[type, ...]]] = {
    ...
    "pheromones": {
        "scent_center_intensity": (int, float),
        "scent_min_center_intensity": (int, float),
        "scent_decay_rate": (int, float), "scent_field_size": int,
    },
...
_PROTECTED: dict[str, Any] = {
    ...
    "pheromones.scent_center_intensity": 0.9,
    "pheromones.scent_min_center_intensity": 0.5,
    "pheromones.scent_decay_rate": 0.1,
    "pheromones.scent_field_size": 5,
