...
def finalize_submission_bundle(
    ...
    *,
    ...
    first_meeting_between_groups: bool = False,
    games_played_including_this: dict[str, int] | None = None,
) -> list[Path]:
    ...
    if games_played_including_this is None:
        ...
        games_played_including_this = {
            key: int(previous_counted_games) + increment for key in participants
        }
    ...
    final.update({
        ...
        "first_meeting_between_groups": bool(first_meeting_between_groups),
